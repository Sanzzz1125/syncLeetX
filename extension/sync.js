...
async function syncToGitHub(data) {
    try {
        ...
        const githubToken = storage.githubToken;
        const repo = storage.githubRepo;
        ...
        const stats = await getLeetCodeStats(data.username, leetcodeSession);
